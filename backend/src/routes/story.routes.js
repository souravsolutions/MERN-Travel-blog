...
import { addStory, allstory, getSingleStory, likeStory } from "../controllers/story.controller.js"
import upload from "../middlewares/multer-middleware.js"

const storyRoute = Router()

storyRoute.route("/addstory").post(authMiddleware,upload.single('image'), addStory)
